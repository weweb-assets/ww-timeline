export default {
    ...
    properties: {
        ...
        markerShape: {
            ...
            bindingValidation: {
                type: 'string',
                tooltip: 'The shape of the timeline markers: circle or square',
            },
            /* wwEditor:end */
        },
        markerIconOnOff: {
            ...
            bindingValidation: {
                type: 'boolean',
                tooltip: 'Toggle marker icon visibility',
            },
            /* wwEditor:end */
        },
        markerIcon: {
            ...
            bindingValidation: {
                type: 'string',
                tooltip: 'The icon to display in timeline markers',
            },
            /* wwEditor:end */
        },
        markerIconColor: {
        ...
        markerBackgroundColor: {
            ...
            bindingValidation: {
                type: 'string',
                tooltip: 'The background color of timeline markers',
            },
            /* wwEditor:end */
        },
        ...
        connectorColor: {
            ...
            bindingValidation: {
                type: 'string',
                tooltip: 'The color of the timeline connector line',
            },
            /* wwEditor:end */
        },
        connectorWidth: {
            ...
            bindingValidation: {
                type: 'string',
                tooltip: 'The width of the timeline connector line',
            },
            /* wwEditor:end */
        },
        timelineLayout: {
            ...
            bindingValidation: {
                type: 'string',
                tooltip: 'The layout orientation of the timeline: vertical or horizontal',
            },
            /* wwEditor:end */
        },
        eventsAlignmentVertical: {
            ...
            options: {
                choices: [
                    ...
                    { value: 'alternate', title: 'Alternate', icon: '16/alignment-justify' },
                ],
            },
            /* wwEditor:start */
            bindingValidation: {
                type: 'string',
                tooltip: 'The alignment of timeline events: left/right/alternate for vertical, top/bottom for horizontal',
            },
            /* wwEditor:end */
        },
